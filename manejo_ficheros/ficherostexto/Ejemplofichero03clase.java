...
public class Ejemplofichero03clase {
	...
	public static void main(String[] args) {
		try {
			...
			BufferedWriter bw = new BufferedWriter(
					new FileWriter("c:\\DIGITECH\\xx.EJERCICIOS\\Prueba\\fruta.txt.txt", true));
			// Si le añadimos ",true" al final de la linea anterior no pisa la información
			// solo lo añade al ya existenete.
